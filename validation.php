...
<body onload=display_ct();>
  ...
  <div class="container-fluid">
    ...
    /**
     * ======================================================
     * mencocokkan qr code dengan identitas mahasiswa/staf
     * validasi jumlah kuota ruangan
     * ======================================================
     */
    $url = "$_POST[input_qr]";
    ...
    if (mysqli_num_rows($sql) < 1) {
      ...
      if (mysqli_num_rows($sql_staf) < 1) {

        /**
         * ======================================================
         * pengecekan mahasiswa yang tidak terjadwal
         * query mahasiswa tidak terjadwal
         * ======================================================
         */
        $free_access = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE nim = '$input_qr'");
        if (mysqli_num_rows($free_access) < 1) {
          echo "<div class='row'>
                      <div class='col greet'>
          ...
          if ($counterFree < 20) {
            ...
            # jika kuota tidak terjadwal penuh
            echo "<div class='row'>
                    <div class='col greet'>
                      <h1>MAAF, KUOTA PENUH</h1>
                      <i>kuota untuk tidak terjadwal penuh...</i>
                    </div>
                  </div>";
          }
        }
      ...
      /**
       * ======================================================
       * pengecekan mahasiswa yang terjadwal
       * pengecekan redundansi akses masuk mahasiswa terjadwal
      ...
      if ($counterStudent < 80) {
        ...
        <?php Query::insertLog($row['nim'], 'check in', 'terjadwal', $conn);
        } else {
          echo "<div class='row'>
                  <div class='col greet'>
                      <h1>MAAF, AKSES DITOLAK..</h1>
